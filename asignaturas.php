...
$id_curso = $_GET['id_curso']; // Recoge el id_curso de la URL
...
// Consulta para obtener las asignaturas del módulo y curso especificado
$sql = "SELECT a.id_asignatura, a.nombre, COUNT(e.id_ejercicio) AS num_ejercicios
        ...
        WHERE a.id_modulo = $id_modulo AND a.id_curso = $id_curso
